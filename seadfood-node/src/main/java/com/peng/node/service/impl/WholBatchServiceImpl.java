...
public class WholBatchServiceImpl extends ServiceImpl<WholBatchMapper, WholBatch> implements WholBatchService {
    ...
    /**
     * 冷冻加工批号Mapper，新增时校验上游加工批号
     */
    @Resource
    private ProcessBatchMapper processBatchMapper;

    /**
     * 零售商批号Mapper，用于审核零售商进场请求
     */
    @Resource
